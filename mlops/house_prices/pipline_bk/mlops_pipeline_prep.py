...
@pipeline()
def house_prices_data_regression(pipeline_job_input, model_name, build_reference):
...
def construct_pipeline(
    ...
    parent_dir = os.path.join(os.getcwd(), "mlops/house_prices/components")
    #data_dir = os.path.join(os.getcwd(), "mlops/house_prices/data/")
    ...
    pipeline_job = house_prices_data_regression(
