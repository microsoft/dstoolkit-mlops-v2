# How to setup a new UseCase with MLOPS Solution Accelerator

The current repository supports multiple usecase examples. You can create a new usecause by duplicating the folder for one use case and making the necessary changes to include python scripts, pipeline scrips and sample data for the new usecase. 
