"""
This module is designed to preprocess diabetes data for the Azure Machine Learning Diabetes tutorial.

It includes functions for reading raw taxi data
...
def data_prep(data):
    ...
    The method maps columns in  datasets and remove distinct columns
     saving results as a csv file.

    Parameters:
      data (str): a folder for preprocessed data
    """
    useful_columns = str(
        [
            "pregnancies",
